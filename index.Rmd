...
### Crop and mask
 ...
 However, for this tutorial we are not interested in monitoring to complete area covered by the Landsat scenes. Reducing the extent and size of the data will shorten the processing time. We will crop and mask the data based on our forest mask. 
