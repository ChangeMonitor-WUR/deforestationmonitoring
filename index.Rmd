...
Now we want to check how the `bfastMonitor` will perform with the Peru datsets by using the `bfmPixel` to check the behavior of a single pixel in the time series. First you need to load the rasterBrick which we created in the previous section
